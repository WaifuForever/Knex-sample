  ...
  return knex.schema.hasTable('circuits').then(function(exists) {
    if (!exists) {
      ...
      return knex('circuits').del().then(function() {
        ...
        return knex('circuits').insert([
          { name: 'circuit_01', country_id: 1, year: 2018 },
          { name: 'circuit_02', country_id: 2, year: 2020 },
          { name: 'circuit_03', country_id: 3, year: 2020 },
          { name: 'circuit_04', country_id: 4, year: 2020 },
          { name: 'circuit_05', country_id: 5, year: 2020 },
          { name: 'circuit_06', country_id: 6, year: 2021 },
          { name: 'circuit_07', country_id: 7, year: 2020 },
          { name: 'circuit_08', country_id: 8, year: 2021 },
          { name: 'circuit_09', country_id: 9, year: 2022 },
          { name: 'circuit_10', country_id: 10, year: 2020 },
          { name: 'circuit_11', country_id: 3, year: 2018 }
